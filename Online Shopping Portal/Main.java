...
{
	String dateOfBirth,orderHistory;
    char gender;
...
class Suppliers extends Users 
{
    ...
    public Suppliers(int id,String name,long mobileNumber,String address,int itemStock,String paymentStatus,double feedbackRating)
    {
    	this.id = id;
        this.name = name;
        this.mobileNumber = mobileNumber;
